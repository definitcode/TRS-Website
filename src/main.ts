  ...
  try {
    ...
    container.innerHTML = `
      <div style="padding-top:10px; display:block; text-align:left;">
        ...
        <div class="panel w100" style="position:relative; width:100%; box-sizing:border-box;">
        ...
        ${currentUser ? `
          <div class="panel w100 mt-10" id="reply-area" style="width:100%; box-sizing:border-box;">
        ...
        ` : `
          <div class="panel w100 mt-10" style="width:100%; box-sizing:border-box;">
